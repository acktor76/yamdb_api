# Generated by Django 3.2 on 2023-05-05 10:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(0, message='Год выпуска должен быть больше 0'), django.core.validators.MaxValueValidator(2023, message='Год выпуска должен быть не больше текущего')], verbose_name='Год выпуска')),
